...
def howtouse(): 
    ...
    tkinter.Label(rules, text='7. ENJOY', font=('Times', 13)).pack()
...
if(n=="stop watch" or n=="stopwatch" or n=="1"):
    watch=tkinter.Tk()
...
elif(n=="auto correction" or n=="autocorrection" or n=="2"):
...
elif(n=="time conversion" or n=="timeconversion" or n=="conversion" or n=="4"):
